      ...
      {pro.map((proitem,index) => {
        ...
        <div className="wrapper row">
          ...
          <div className="details col-md-7">
            <h3 className="product-title">{proitem.name} | {proitem.category}</h3>
            ...
            <div className="action">
              <button className="add-to-cart btn btn-default" onClick={() => addtocart(proitem)} type="button">add to cart</button>
